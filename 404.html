...
<html lang="en">
    ...
    <body>
        ...
        <!-- main -->
        <main class="d-flex h-100 text-center">
            <div class="d-flex w-100 h-100 p-3 mx-auto flex-column">
                <div class="px-3">
                    <h1>404 Not Found.</h1>
                    <p class="lead">The page you're looking for does not
                        exist.</p>
                    <p class="lead">
                        <a href="index.html"
                            class="btn btn-lg btn-light fw-bold border-white bg-white">Go
                            to homepage</a>
                    </p>
                </div>
            </div>
